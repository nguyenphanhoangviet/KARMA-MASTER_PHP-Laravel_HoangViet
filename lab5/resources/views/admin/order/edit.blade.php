                ...
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex flex-column">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="shipping_fee" name="shipping_fee" value="{{ old('shipping_fee', $order->shipping_fee) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="province" name="province" value="{{ old('province', $order->province) }}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 d-flex flex-column">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="payment_method" name="payment_method">
                                <option value="Thanh toán nhận hàng" {{ old('payment_method', $order->payment_method) == 'Thanh toán nhận hàng' ? 'selected' : '' }}>Thanh toán nhận hàng</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="payment_status" name="payment_status">
                                <option value="Chưa Thanh Toán" {{ old('payment_status', $order->payment_status) == 'Chưa Thanh Toán' ? 'selected' : '' }}>Chưa Thanh Toán</option>
                                <option value="Giao dịch thành công" {{ old('payment_status', $order->payment_status) == 'Giao dịch thành công' ? 'selected' : '' }}>Giao dịch thành công</option>
                                <option value="Giao dịch thất bại" {{ old('payment_status', $order->payment_status) == 'Giao dịch thất bại' ? 'selected' : '' }}>Giao dịch thất bại</option>
                            </select>
                        </div>
                    </div>
                </div>
