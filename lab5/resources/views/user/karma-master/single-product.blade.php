				...
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="{{ asset('imgs/products/' . $product->img) }}" alt="{{ $product->name }}">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="{{ asset('imgs/products/' . $product->img) }}" alt="{{ $product->name }}">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
							...
							<li><a href="#"><span>Availibility</span> : {{ $product->stock > 0 ? 'In Stock' : 'Out of Stock' }}</a></li>
						</ul>
			...
			<div class="row">
				<div class="col-lg-9">
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="{{ asset('imgs/karma-master/r10.jpg') }}" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="{{ asset('imgs/karma-master/r11.jpg') }}" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
				...
				<div class="col-lg-3">
					<div class="ctg-right">
						<a href="#" target="_blank">
							<img class="img-fluid d-block mx-auto" src="{{ asset('imgs/karma-master/category/c5.jpg') }}" alt="">
						</a>
					</div>
				</div>
			</div>
